...
/**
 * Moves the elevator to a specified encoder position using position PID.
 * 
 * @author Aimee W
 * @author Shahzeb L
 * @author Jatin K
...
public class MoveElevatorPosition extends Command {
   ...
   protected boolean isFinished() {
      return false;// Math.abs(Elevator.getInstance().getMasterTalon().getClosedLoopError(Global.PID_PRIMARY))
                   // <= ALLOWABLE_ERROR;
   }
