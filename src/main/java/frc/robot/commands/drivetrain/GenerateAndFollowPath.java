...
//      */
//     public GenerateAndFollowPath(Waypoint [] points, int dt)
//     {
// 		this(points);
//         this.dt = dt;
//         period = dt/2;
...
//      */
//     public GenerateAndFollowPath(Waypoint [] points, int dt, double maxVelocity, double maxAcceleration)
//     {
//         this(points, dt);
...
//      */
//     public GenerateAndFollowPath(Waypoint [] points, int dt, double maxVelocity, double maxAcceleration, double wheelBase)
//     {
...
//             initialX = points[i].x;
//             initialY = points[i].y;
//             initialDx = points[i].angle;

//             finalX = points[i + 1].x;
//             finalY = points[i + 1].y;
//             finalDx = points[i + 1].angle;
...
// 		// System.out.println("Number of left points: " + leftTrajectory.size());
// 		// System.out.println("Number of right points: " + rightTrajectory.size());
...
//         velocity = calculateVelocityOutput(prevVelocity, position, distanceLeft, angularVelocity);
