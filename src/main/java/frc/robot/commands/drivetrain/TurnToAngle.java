...
public class TurnToAngle extends Command {
   ...
   protected void initialize() {
      ...
      Drivetrain.getInstance().getLeftMaster().configRemoteFeedbackFilter(CAN_IDs.PIGEON, RemoteSensorSource.Pigeon_Yaw,
            Global.REMOTE_SLOT_0);
      Drivetrain.getInstance().getRightMaster().configRemoteFeedbackFilter(CAN_IDs.PIGEON,
            RemoteSensorSource.Pigeon_Yaw, Global.REMOTE_SLOT_0);

      Drivetrain.getInstance().getLeftMaster().configSelectedFeedbackSensor(RemoteFeedbackDevice.RemoteSensor0,
            Global.PID_PRIMARY);
      Drivetrain.getInstance().getRightMaster().configSelectedFeedbackSensor(RemoteFeedbackDevice.RemoteSensor0,
            Global.PID_PRIMARY);
