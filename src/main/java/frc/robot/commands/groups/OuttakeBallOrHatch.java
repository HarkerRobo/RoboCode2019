 ...
 * the wrist contains. It will outtake a hatch panel only if the wrist contains
 * one, otherwise it will outtake cargo, regardless of whether there is a cargo
 * ball.
 * 
...
public class OuttakeBallOrHatch extends ConditionalCommand {
   public OuttakeBallOrHatch() {
      super(new LoadOrScoreHatch(ScoreState.SCORE),
